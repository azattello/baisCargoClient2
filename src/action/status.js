...
export const getStatus = async () => {
  try {
      const response = await axios.get('https://86.107.44.226:3001/api/status/getStatus');
...
export const deleteStatus = async (statusId) => {
  try {
    ...
    const response = await axios.delete(`https://86.107.44.226:3001/api/status/deleteStatus/${statusId}`);
